...
5. Set the Wolfkrow environment variables.
    ...
    WOLFKROW_DEFAULT_COMMAND_LINE_EXECUTABLE: C:/Program Files/python/3.9.13/python.exe
    Path to the wolfkrow_run_task python script.
    WOLFKROW_DEFAULT_COMMAND_LINE_EXECUTABLE_ARGS: C:/Projects/Wolfkrow/src/wolfkrow/scripts/wolfkrow_run_task.py
    ...
    The path to the wolfkrow.yaml file provided with the demo.
    WOLFKROW_CONFIG_SEARCH_PATHS: <repo_root>/_config/wolfkrow.yaml
